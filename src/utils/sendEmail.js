...
//                           <tr>
//                             <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
//                               <p href="#" target="_blank" style="display: inline-block; padding: 15px 20px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">${text} </p>
//                             </td>
//                           </tr>
//                         </table>
//                       </td>
...
//               <tr>
//                 <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
//                   <p style="margin: 0;">Cheers,<br> Ali Allam</p>
//                 </td>
//               </tr>
//               <!-- end copy -->
...
//   });
//   const info = await transporter.sendMail({
//     from: `"Ali Abdallah" <${process.env.EMAIL}>`, // sender address
//     to, // list of receivers
//     subject, // Subject line
//     text, // plain text body
//     html, // html body,
